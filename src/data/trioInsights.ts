...
export const trioInsights: Record<string, TrioInsight> = {
  ...
  'cavern-oasis-trace': {
    title: 'The Cherished Comparison',
  ...
  'dross-languish-mist': {
    title: 'The Foggy Self-Rejection',
  ...
  'dross-mist-zenith': {
    title: 'The Questioning Achiever',
  ...
  'dross-oasis-trace': {
    title: 'The Self-Critical Romantic',
  ...
  'glare-mist-oasis': {
    title: 'The Curious Vulnerability',
  ...
  'glare-mist-zenith': {
    title: 'The Confident Uncertainty',
